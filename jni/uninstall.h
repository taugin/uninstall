...
static const char *MONITOR_PATH = "/data/data/%s/lib/libmonitor.so";
static const char *MONITOR_LIBPATH = "/data/data/%s/lib";
static const char *JNIREG_CLASS = "com/android/uninstall/UninstallObserver";
